...
const InGeneral = () => (
    ...
    >
    <p style={{marginBottom:15}}><strong>体博会尺寸（宽 × 高）：21厘米 × 29.7厘米（或 210毫米 × 297毫米）</strong></p>
    <p style={{marginBottom:15, textIndent:'2em'}}>我们平时所用的体博会是全球使用的标准纸张尺寸（体博会由ISO 216定义的。ISO 216定义了A、B、C三组纸张尺寸，C组纸张尺寸主要使用于信封），北美国家除外。 美国，加拿大和墨西哥的标准尺寸为8.5英寸×11英寸（约21.5厘米×27.9厘米），通常称为“信件”尺寸。 而体博会稍微长一点，大约在8.27英寸乘11.75英寸（21厘米乘29.7厘米）。 这种和其他类型的“A”纸张尺寸基于公制测量系统并通过国际欧洲标准建立。</p>
    </div>	
)
...
const IndexNav = () => (
	...
	>
		<li><a rel="nofollow" href="#a4z-size">体博会大小</a></li>
		<li><a rel="nofollow" href="#a4z-origin">体博会形成的基础</a></li>
		<li><a rel="nofollow" href="#a4z-weight">体博会张重量</a></li>
		<li><a rel="nofollow" href="#a4z-pixel">体博会像素分辨率换算</a></li>
	</ul>
)
...
const Paragraphs = () => (
	<div style={{margin: '15px 0'}}>
		<dl className="clearfix">
			...
			<dt id="a4z-origin">② 体博会形成的基础</dt>
			<dd>
				<p style={{ marginTop: 15, paddingLeft: 20, textIndent:'2em'}}>体博会和相似尺寸基于公制测量。 如下图：一张A0纸张铺平后，面积为一平方米，最大尺寸为84.1厘米×118.9厘米（约33英寸×46.75英寸）。 切成两半的A0纸在大约59.4厘米乘84.1厘米（或23.38英寸乘33英寸）处变成A1尺寸。 A1减半是A2，依此类推到A6。
					</p>
				...
				<p style={{ marginTop: 15, paddingLeft: 20, textIndent:'2em'}}>纸张尺寸的这个系统的价值是每个尺寸与下一个尺寸成比例。 体博会例如大约21厘米×29.7厘米（大约8.27英寸×11.75英寸），而A3是29.7厘米×42厘米（大约11.75英寸×16.5英寸）。 如果有人在一张体博会上放置了文字或图像，并想把它放大到A3纸上，可以很容易地完成，而不会丢失文档的任何内容。 这个使用2的平方根（即1.414）的比例被称为Lichtenberg比率，以德国物理学家的名字命名，他首先指出了它的用处。
					</p>
				<img src={'/img/a4z.jpg'} alt="体博会尺寸：21厘米 × 29.7厘米（210毫米 × 297毫米）" title="体博会尺寸：21厘米 × 29.7厘米（210毫米 × 297毫米）"/>			
			</dd>
			<dt id="a4z-weight">③ 体博会张重量</dt>
			<dd>
			<p style={{ marginTop: 15, paddingLeft: 20, textIndent:'2em'}}>欧洲纸张的重量基于公制系统，并在ISO标准536（最初于1976年开发并于1995年更新）标准化。欧洲和其他非美国纸张的加权基于每平方米的克数（g / m<sup>2</sup> ）为每种类型的纸张。 体博会可用于大多数标准纸张重量; A4打印纸的重量为90克/平方米，而封面纸为250克/平方米。</p>			
			</dd>
			<dt id="a4z-pixel">④ 体博会像素分辨率换算</dt>
			<dd>
...
const IndexPage = () => (
  <div style={{paddingBottom: 50}}>
    <Helmet
      title="体博会网址导航 - 体博会网址是什么？什么是体博会？"
      meta={[
        { name: 'description', content: '体博会网址导航' },
        { name: 'keywords', content: '体博会网址,体博会是什么,体博会, 体博会网址导航' },
      ]}
    />
  	<InGeneral />
  	<IndexNav />
